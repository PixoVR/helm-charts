...
{{- define "sa_email" -}}
  ...
  {{- else }}
    {{- .Values.config_connector.sa_name -}}@{{- required "config_connector.sa_email OR config_connector.sa_project_id" .Values.config_connector.sa_project_id -}}.iam.gserviceaccount.com
  {{- end -}}
{{- end -}}
